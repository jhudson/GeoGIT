...
/**
 * The ObjectSerialisingFactory is used to create instances of the various
 * writers and readers used to work with the serialised forms of various 
 * repository elements.
 * 
 * @author mleslie
 *
...
public interface ObjectSerialisingFactory {
	...
	/**
	 * Creates an instance of a RevTree reader that will start reading a the
	 * given tree depth.
	 * 
	 * @param objectDb the ObjectDatabase the RevTree is stored in
	...
	/**
	 * Creates an instance of a Feature reader that can parse features of the
	 * given feature type.
	 * 
	...
	/**
	 * Creates a BlobPrinter that can parse serialised elements into a 
	 * human-readable(ish) representation, typically xml.
	 * 
